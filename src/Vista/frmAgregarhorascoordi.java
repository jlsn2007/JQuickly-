...
public class frmAgregarhorascoordi extends javax.swing.JFrame {
    ...
    public static void initfrmAgregarhorascoordi(){
        
        frmAgregarhorascoordi vistaAgregarhorascoordi = new frmAgregarhorascoordi();
        Usuario moduscoordi = new Usuario();
        Expediente modexcoordi = new Expediente();
        
        ctrlAgregarhorascoodi controlador = new ctrlAgregarhorascoodi(vistaAgregarhorascoordi, moduscoordi, modexcoordi);
        
        vistaAgregarhorascoordi.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jtbAlumnos.setForeground(new java.awt.Color(255, 153, 51));
        ...
        jtbAlumnos.setSelectionBackground(new java.awt.Color(255, 153, 51));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAgregarhorascoordi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
